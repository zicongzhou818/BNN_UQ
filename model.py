...
def UNet(N_filters=32):
    ...
    layer6 = Conv2DReluBatchNorm(32*N_filters, (3, 3), (2,2), layer5)

    merge7 = Concatenate(axis=-1)([UpSampling2D(size=(2,2))(layer6), layer5])
    layer7 = Conv2DReluBatchNorm(16*N_filters, (3, 3), (1,1), merge7)
    
    merge8 = Concatenate(axis=-1)([UpSampling2D(size=(2,2))(layer7), layer4])
    layer8 = Conv2DReluBatchNorm(8*N_filters, (3, 3), (1,1), merge8)
    
    merge9 = Concatenate(axis=-1)([UpSampling2D(size=(2,2))(layer8), layer3])
    layer9 = Conv2DReluBatchNorm(4*N_filters, (3, 3), (1,1), merge9)

    merge10 = Concatenate(axis=-1)([UpSampling2D(size=(2,2))(layer9), layer2])
    layer10 = Conv2DReluBatchNorm(2*N_filters, (3, 3), (1,1), merge10)

    merge11 = Concatenate(axis=-1)([UpSampling2D(size=(2,2))(layer10), layer1])
    layer11 = Conv2DReluBatchNorm(N_filters, (3, 3), (1,1), merge11)

    output = Conv2D(1, (1, 1), strides=(1,1), activation='sigmoid', name='output')(layer11)    
